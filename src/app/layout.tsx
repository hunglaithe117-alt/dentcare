...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Laboratory specialized in Aesthetics and Implantology. Over 30 years of experience.",
...
export default function RootLayout({
  ...
  const organizationSchema = {
    ...
    description:
      "Laboratory specialized in Aesthetics and Implantology with over 30 years of experience and ISO 13485 certification",
    address: [
      {
        "@type": "PostalAddress",
