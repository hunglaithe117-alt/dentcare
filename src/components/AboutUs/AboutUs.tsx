  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        {/* Section header */}
        <div
          className={`text-center mb-16 lg:mb-20 transition-[opacity,transform] duration-1000 motion-reduce:duration-0 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8 motion-reduce:opacity-100 motion-reduce:translate-y-0"}`}
        >
        ...
        {/* History */}
        <div
          className={`grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center transition-[opacity,transform] duration-1000 delay-200 motion-reduce:duration-0 motion-reduce:delay-0 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8 motion-reduce:opacity-100 motion-reduce:translate-y-0"}`}
        >
        ...
        {/* Method */}
        <div
          className={`mt-24 mb-24 transition-[opacity,transform] duration-1000 delay-300 motion-reduce:duration-0 motion-reduce:delay-0 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8 motion-reduce:opacity-100 motion-reduce:translate-y-0"}`}
        >
          <div className="mb-16">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="border border-neutral-300 bg-black shadow-[0_8px_24px_rgba(15,23,42,0.08)]">
                <div className="relative w-full aspect-video overflow-hidden bg-black">
                  <iframe
                    className="absolute -inset-px h-[calc(100%+2px)] w-[calc(100%+2px)] rounded-none"
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {methods.map(({ key, image }, index) => (
              <div
                key={key}
                className="group p-6 bg-neutral-50 rounded-2xl border border-neutral-100 hover:border-accent-200 hover:shadow-lg hover:shadow-accent-100/50 transition-[transform,box-shadow,border-color] hover:-translate-y-1"
